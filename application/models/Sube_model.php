...
{
    public string $table_name = "subeler";
     ...
     * @return array
     */
    public function get_sube_sayisi(array $where = array()): array
    {
        $this->db->select('kurum_kodu, COUNT(*) as sube_sayisi');
        $this->db->from($this->table_name);
        ...
        $query = $this->db->get();
        return array_column($query->result_array(), 'sube_sayisi', 'kurum_kodu'); // Kurum kodu => Şube sayısı
    }
