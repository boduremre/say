                ...
                <div class="table-responsive">
                    <table class="table table-hover datatable" data-order-column="0" data-order-direction="asc">
                        ...
                        <tr>
                            ...
                            <th class="text-center">Ortalama Puan <i class="fa fa-info-circle" data-toggle="tooltip" title="Sınavda başarı kriteri 50 puan olarak alınmıştır."></i>
                            </th>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if ($sinav->yayin_durumu == 0) { ?>
                                        ...
                                        <a href="javascript:void(0)" data-url="<?php echo site_url('sinavlar/delete/') . $sinav->id; ?>" class="btn btn-danger btn-xs remove-btn"
                                           data-toggle="tooltip"
