        ...
        <?php foreach ($sinavlar as $sinav) { ?>
            <tr>
                ...
                <td>
                    ...
                    <?php if ($sinav->yayin_durumu == 0) { ?>
                        <a href="<?php echo site_url('sinavlar/analyze/').$sinav->dogrulama_kodu; ?>" data-toggle="tooltip" title="Analiz İşlemi" class="btn btn-dark btn-xs">
                            <i class="fa fa-share"></i>
                        </a>
                        <a href="<?php echo site_url('sinavlar/delete/'). $sinav->id; ?>" class="btn btn-danger btn-xs" data-toggle="tooltip" title="Sil (Analiz Yapılmayan Sınav Silinebilir)">
