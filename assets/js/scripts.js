  ...
  var toggle_sidebar_mini = function (mini) {
    ...
    if (!mini) {
      ...
      $(".sidebar-menu").each(function () {
        if ($(this).find("li a.toggled").length) {
          $(this).find("li a.toggled").removeClass("toggled");
        }
      });
      ...
      if (now_layout_class == "layout-3") {
        ...
        main_sidebar.find(".sidebar-menu").before(
          $("<div>", {
            ...
            ' <a href="index.html"> <img alt="image" src="assets/img/logo.png" class="header-logo" /> <span class="logo-name">Jiva</span> </a>'
          )
        );
